            ...
            <main className="pt-28 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
                ...
                <div className="prose prose-slate max-w-none space-y-10">
                    ...
                    <Section title="2. Recommended Retention Periods">
                        <p>The following are general recommendations. Adjust based on your compliance requirements and storage capacity:</p>
                        <ul>
                            <li><strong>Metrics data:</strong> 30–90 days for operational monitoring. Archive or delete older records.</li>
                            <li><strong>Event logs:</strong> 90–180 days for security auditing. Longer retention may be required by compliance frameworks (e.g., ISO 27001, SOC 2, HIPAA).</li>
                            <li><strong>System logs:</strong> 30 days for debugging purposes.</li>
                            <li><strong>Machine records:</strong> Retain as long as the machine is active. Delete records for decommissioned machines.</li>
                        </ul>
                    </Section>
...
0 2 * * 0 sqlite3 /DATA/AppData/Monitor/systracker.db "DELETE FROM metrics WHERE timestamp < datetime('now', '-90 days'); DELETE FROM events WHERE timestamp < datetime('now', '-180 days'); VACUUM;"`}
                        </pre>
                    ...
                    <Section title="5. Compliance Considerations">
                        <p>Depending on your jurisdiction and industry, you may be subject to data retention requirements. Common frameworks include:</p>
                        <ul>
                            <li><strong>GDPR (EU):</strong> Data must not be kept longer than necessary for its purpose. Implement deletion schedules and document your retention policy.</li>
                        ...
                        <p>Consult a legal or compliance professional to determine the appropriate retention period for your organization.</p>
                    </Section>

                    <Section title="6. Data Deletion Requests">
                        <p>If a monitored user requests deletion of their data (e.g., under GDPR's right to erasure), the administrator is responsible for identifying and deleting all records associated with that user's machine(s) from the SysTracker database.</p>
                        <pre className="bg-slate-900 text-green-400 p-4 rounded-xl text-sm overflow-x-auto font-mono">
