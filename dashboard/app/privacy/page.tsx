            ...
            <main className="pt-28 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
                ...
                <div className="prose prose-slate max-w-none space-y-10">
                    ...
                    <Section title="5. Access Control">
                        <p>The SysTracker dashboard does not include built-in user authentication in its current version. <strong>It is your responsibility</strong> to restrict access to the dashboard and server API using network-level controls (firewall rules, VPN, reverse proxy with authentication).</p>
                        <p>Failure to restrict access may expose sensitive machine data to unauthorized parties on your network.</p>
                    </Section>

                    <Section title="6. Third-Party Services">
                        <p>The SysTracker dashboard uses the following third-party resources:</p>
                        <ul>
                            <li><strong>DiceBear Avatars API</strong> (<code>api.dicebear.com</code>): Used optionally when an administrator randomizes a profile avatar. A request is made to DiceBear's public API with a random seed. No personal data is sent. DiceBear's own privacy policy applies.</li>
                    ...
                    <Section title="8. Security Recommendations">
                        <ul>
                            <li>Deploy the server behind a VPN or reverse proxy with authentication (e.g., Nginx + Basic Auth, Authelia, Cloudflare Access).</li>
                    ...
                    <Section title="9. Changes to This Policy">
                        <p>This policy may be updated as new features are added to SysTracker. The "Last updated" date at the top of this page will reflect any changes. Continued use of the Software after changes constitutes acceptance of the updated policy.</p>
                    </Section>
