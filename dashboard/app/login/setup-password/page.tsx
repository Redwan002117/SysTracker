    ...
    return (
        <>
            <div className="text-center mb-8">
                ...
                <h1 className="text-2xl font-bold text-slate-900">Welcome to SysTracker!</h1>
                <p className="text-slate-500 mt-2">Set your password to activate your account.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                    {loading ? 'Setting up...' : <><CheckCircle size={18} /> Complete Setup</>}
                </button>
            </form>
